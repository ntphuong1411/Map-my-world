...
if("TRUE" STREQUAL "TRUE")
  set(pgm_map_creator_SOURCE_PREFIX /root/project3_new/src/pgm_map_creator)
  set(pgm_map_creator_DEVEL_PREFIX /root/project3_new/devel)
  ...
  set(pgm_map_creator_INSTALL_PREFIX /root/project3_new/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pgm_map_creator' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/project3_new/src/pgm_map_creator/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /root/project3_new/devel/lib;/root/catkin_ws/devel/lib;/opt/ros/noetic/lib)
